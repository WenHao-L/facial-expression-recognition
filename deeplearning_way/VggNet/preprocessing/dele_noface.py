...
cwd = os.getcwd()
path = os.path.join(cwd, 'datasets', 'fer2013', 'fer2013.csv')
...
# read the tag
label_path = os.path.join(cwd, 'datasets', 'fer2013', 'fer_plus.csv')
...
print(len(data_new))
new_path = os.path.join(cwd, 'datasets', 'fer2013', 'fer2013_new.csv')
